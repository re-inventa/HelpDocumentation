...
Esta guía está dirigida a usuarios, operadores y responsables funcionales. Explica qué hace Reagentia y cómo utilizarla sin depender de detalles internos de implementación.
...
!!! note "La pantalla manda"
    Reagentia solo muestra acciones aplicables a tu rol y al estado actual. Si una opción no aparece, comprueba primero permisos, publicación de la configuración y estado de la ejecución.
